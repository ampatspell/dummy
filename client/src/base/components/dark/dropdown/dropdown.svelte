<script lang="ts" generics="T">
  import LucideChevronDown from '$base/components/icons/lucide--chevron-down.svelte';
  import LucideChevronUp from '$base/components/icons/lucide--chevron-up.svelte';
